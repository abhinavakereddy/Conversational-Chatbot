...
st.set_page_config(page_title="Generating Image Captions Based on Deep Learning and Natural Language Processing")

st.header("Generating Image Captions Based on Deep Learning and Natural Language Processing")
